/*
the click.click file in the click-qos directory will assign a DSCP value to a frame going to the VPN network, or it will give priority to frames coming from the VPN-net with a certain DSCP value
*/
