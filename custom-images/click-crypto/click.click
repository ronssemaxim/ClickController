/*
the click.click file in the click-crypto directory will encrypt traffic going to the VPN-network, or it will decrypt traffic coming from the VPN-network.
*/
